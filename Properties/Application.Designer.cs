...
namespace atmsystem
{
	namespace My
	{
		...
		{
            [STAThread]
            static void Main() => (new MyApplication()).Run(new string[] { });

            [global::System.Diagnostics.DebuggerStepThrough()]public MyApplication() : base(authenticationMode: global::Microsoft.VisualBasic.ApplicationServices.AuthenticationMode.Windows)
			{
			...
			{
				this.MainForm = global::atmsystem.Login_frm.Default;
			}
		}
	}
