...
namespace Atmsystem
{
    ...
    public partial class Regs_frm : System.Windows.Forms.Form
    {
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            string accountNumber = txtAcctNo.Text.Trim();
            ...
            if (string.IsNullOrEmpty(pincode)||string.IsNullOrEmpty(accountNumber))

            {
                MessageBox.Show("Please enter both Pincode and Account Number.","Validation Error",MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
